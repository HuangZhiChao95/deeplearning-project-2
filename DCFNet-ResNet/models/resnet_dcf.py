...
k = -1
weights = np.load('./bases/bases_resnet.npy')

def CONV_DCF(in_channels, out_channels, kernel_size, num_bases, stride=1, padding=0, 
             bias=True, initializer='FB'):
    global k
    if initializer == 'PCA':
        k+=1
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers ,in_channels, num_bases, initializer='FB', num_classes=10):
        self.inplanes = 64
